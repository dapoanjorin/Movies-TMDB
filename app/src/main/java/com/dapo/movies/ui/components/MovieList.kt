package com.dapo.movies.ui.components
...
@Composable
fun MovieList(
    flowData: Flow<PagingData<Movie>>,
    ...
    val lazyData: LazyPagingItems<Movie> =
...
private fun MovieImage(
    data: Movie?,
    onImageClicked: (Movie?) -> Unit,
    onImageLongClicked: (Movie?) -> Unit
) {

    val imageColorParsed = Color(0xFF212121)
    ...
    Box(
        ...
        Card(
            ...
            Image(
                painter = rememberImagePainter(data?.url?.attributionUrl) {
